...
<title>Administration area for: {site_url}</title>
...
<body bgcolor="#FFFFFF" topmargin="6" marginheight="6" leftmargin="6" marginwidth="6" onload="MM_preloadImages('/admin/images/{site_style}/redigerminimrk.gif','/admin/images/{site_style}/slettminimrk.gif','/admin/images/{site_style}/downloadminimrk.gif','/admin/images/{site_style}/imagemapminimrk.gif')">
...
<tr>
	...
	<a href="http://{admin_site_url}" target="_vblank"><h1>xPublish</h1> <!-- <img src="{www_dir}/admin/images/{site_style}/top-ezpublishlogo.gif" width="200" height="40" border="0" alt="" /> --> </a><br />
	</td>
