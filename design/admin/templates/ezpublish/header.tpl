...
<!-- BEGIN module_item_tpl -->
	<td align="center"><a href="{www_dir}{index}/module/{module_action}/{ez_module_name}?RefURL={ref_url}"><img src="{www_dir}/kernel/{ez_dir_name}/admin/images/module_icon.png" width="32" height="32" border="0" alt="{module_name}" title="{module_name}" /></a></td>
<!-- END module_item_tpl -->
