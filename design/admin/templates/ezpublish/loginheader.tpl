...
<tr>
	...
	<a href="http://basic.exponential.earth" target="_vblank"><img src="{www_dir}/design/admin/images/{site_style}/top-ezpublishlogo.gif" width="200" height="40" border="0" alt="" /></a><br />
	</td>
	<td width="92%">
