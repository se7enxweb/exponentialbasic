...
<!-- BEGIN module_item_tpl -->
	<a href="{www_dir}{index}/module/{module_action}/{ez_module_name}?RefURL={ref_url}" onmouseover="window.status='{module_name}'; return true"><img src="{www_dir}{module_icon}" width="64" height="64" border="0" alt="{module_name}" title="{module_name}" /></a>
<!-- END module_item_tpl -->
	</td>
