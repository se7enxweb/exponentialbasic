...
<tr>
	...
	<tr>
		...
		<!-- Ikon: Start -->
		<img src="{www_dir}/{module_dir}/admin/images/module_icon.gif" width="32" height="32" border="0" align="absmiddle" alt="{intl-module_name}" />
		<!-- Ikon: Slutt -->
		</a>
		...
		<td width="1%">
		<a href="{www_dir}{index}{move_down_uri}"><img src="{www_dir}/design/admin/images/{site_style}/move-down.gif" width="12" height="12" border="0" alt="" /></a><br />
		</td>
		<td width="1%">
...
<tr>
    <td class="repeaty" width="1%" valign="bottom"><img src="{www_dir}/design/admin/images/{site_style}/box-l03closed.gif" width="10" height="10" border="0" alt="" /><br /></td>
    <td class="repeatx" width="98%" background="{www_dir}/design/admin/images/{site_style}/top-m02.gif" valign="absmiddle" bgcolor="#ffffff"><img src="{www_dir}/design/admin/images/{site_style}/1x1.gif" width="160" height="10" border="0" alt="" /><br /></td>
    <td class="repeaty" width="1%" valign="bottom"><img src="{www_dir}/design/admin/images/{site_style}/box-r03closed.gif" width="10" height="10" border="0" alt="" /><br /></td>
</tr>
<tr>
