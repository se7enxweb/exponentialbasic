...
{starttr}
	...
	<img src="{www_dir}/design/base/images/icons/path-arrow.gif" height="10" width="12" border="0" alt="">&nbsp;<a class="path" href="{www_dir}{index}{news_url}" target="_vblank">{intl-read_more}</a>
	</td>
{endtr}
<!-- END news_item_tpl -->
</table>
