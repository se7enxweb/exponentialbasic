...
<tr>
	...
	<th>&nbsp;
	<td width="1%"><a href="{www_dir}{index}{item_down_command}"><img src="{www_dir}/design/admin/images/move-down.gif" height="12" width="12" border="0" alt="Move down" /></a></td>
	<td width="1%"><a href="{www_dir}{index}{item_up_command}"><img src="{www_dir}/design/admin/images/move-up.gif" height="12" width="12" border="0" alt="Move up" /></a></td>
	</th>
	<th>&nbsp;
	</th>
	<td width="1%">
...
<tr>
	...
	<td class="{td_class}" width="1%"><a href="{www_dir}{index}{item_down_command}"><img src="{www_dir}/design/admin/images/move-down.gif" height="12" width="12" border="0" alt="Move down" /></a></td>
	<td class="{td_class}" width="1%"><a href="{www_dir}{index}{item_up_command}"><img src="{www_dir}/design/admin/images/move-up.gif" height="12" width="12" border="0" alt="Move up" /></a></td>
