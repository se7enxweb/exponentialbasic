...
<!-- BEGIN category_headline_item_tpl -->	
<h1 class="mainHeading">{current_category_name}</h1>
<!-- END category_headline_item_tpl -->	
	</td>
</tr>
</table>
<!-- END header_item_tpl -->
...
<div class="p" style="padding-left: 12px;">{current_category_description}</div>
<!-- </div> -->
...
<tr>
	...
	<br/>
        ...
        <!-- BEGIN read_more_tpl -->
	<img src="{www_dir}/design/images/path-arrow.gif" height="10" width="12" border="0" alt="" />
