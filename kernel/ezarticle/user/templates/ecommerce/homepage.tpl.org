        ...
        <div id="contentWrap" style="position:relative; top: 7px;">
	      ...
	      <!-- BEGIN distributor_image_box_tpl -->
              <div id="importBox">
                ...
                <span class="importBoxWrap" style="margin: auto;">
			  <!-- BEGIN distributor_image_item_tpl -->
					...
					<img1 src="{www_dir}/{thumbnail_image_uri}" width="{thumbnail_image_width}" height="{thumbnail_image_height}" alt="{category_description}" border="1" />
					</a>
					</span>
					<!-- END distributor_image_tpl -->
					<a href="{www_dir}{index}/trade/productlist/{category_id}" title="{category_description}">{category_name}</a></p>
			               </span> 
		...
		<div id="dealer">
          ...
          <div id="featuresWrap">
			...
			<h3>{intl-image_categories}</h3>			  
              ...
              <div id="frontRightGallery"><table cellpadding="0" cellspacing="0" border="0" style="padding-top: 10px;"><tr><td>
			<!-- BEGIN image_list_item_tpl -->	                
				<span class="thumbnail" style="float: left; padding: 10px 10px 10px 10px;"><a href="{www_dir}{index}/imagecatalogue/image/list/{category_id}/" title="{category_description}"><img src="{www_dir}/{thumbnail_image_uri}" alt="{category_description}" width="{thumbnail_image_width}" height="{thumbnail_image_height}" border="0" />
				<p>{category_name}</p></a>
				</span>
