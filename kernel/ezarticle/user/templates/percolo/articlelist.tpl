...
<tr>
	<td class="{td_class}">
	<div class="listheadline"><a class="listheadline" href="{www_dir}{index}/article/archive/{category_id}/">{category_name}</a></div>
...
<tr>
	...
	<a class="path" href="{www_dir}{index}/article/archive/{category_id}/">{article_link_text}</a>
