...
<!-- END article_url_item_tpl -->
        ...
        <tr>
            ...
            <td rowspan="3" valign="top" width="1%" align="right"><a href="{www_dir}{index}/tema/bildegalleri"><img src="{www_dir}/design/percolo/images/tittelbilde.gif" alt="Bygg mer enn hus..." width="140" height="100" border="0" /></a><br /></td>
        </tr>
        <tr>
            <td bgcolor="#009ebf" valign="top"><img src="{www_dir}/design/percolo/images/onepix.gif" alt="" width="14" height="32" hspace="0" vspace="0" /><br /></td>
            <td bgcolor="#009ebf" valign="top"><h1 class="sidetittel">{article_name}</h1></td>
        </tr>
        <tr>
            <td><img src="{www_dir}/design/percolo/images/onepix.gif" alt="" width="14" height="14" hspace="0" vspace="0" /><br /></td>
            <td><img src="{www_dir}/design/percolo/images/onepix.gif" alt="" width="50" height="60" hspace="0" vspace="0"></td>
        </tr>
		</table>

        <table width="100%" height="100" border="0" vspace="0" hspace="0" cellpadding="0" cellspacing="0">
		<tr>
		    <td width="1%"><img src="{www_dir}/design/percolo/images/onepix.gif" alt="" width="14" height="14" hspace="0" vspace="0" /><br /></td>
			<td width="99%">
