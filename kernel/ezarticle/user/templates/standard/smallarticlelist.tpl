...
<tr>
	<td colspan="2">
	<a class="path" href="{www_dir}{index}/article/static/{article_id}/1/{category_id}/">{article_name}</a>
	<div class="small">
...
<tr>
	...
	<td width="99%"><a class="menu" href="{www_dir}{index}/article/static/{article_id}/1/{category_id}/">{article_link_text}</a></td>
</tr>
<!-- END read_more_tpl -->
