...
<tr>
	...
	&nbsp;
        ...
        <nobr><a href="/forum/messageedit/edit/{message_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezfrm{message_id}-red','','{www_dir}/design/admin/images/layout/redigerminimrk.gif',1)"><img name="ezfrm{message_id}-red" border="0" src="/images/redigermini.gif" width="16" height="16" align="top" alt="Edit" /></a>&nbsp;<a href="/forum/messageedit/delete/{message_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezfrm{message_id}-slett','','/design/base/images/icons/slettminimrk.gif',1)"><img name="ezfrm{message_id}-slett" border="0" src="/design/base/images/icons/slettmini.gif" width="16" height="16" align="top" alt="Delete" /></a></nobr>
