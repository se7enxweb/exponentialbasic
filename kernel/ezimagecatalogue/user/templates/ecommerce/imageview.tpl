<!-- start #breadcrumbs -->
<div id="breadcrumbs">
&nbsp;<a href="{www_dir}{index}/imagecatalogue/image/list/0/">{intl-top}</a>
<!-- BEGIN path_tpl -->
...
<h1 class="mainHeading">{intl-headline}: {image_name}</h1>
...
<tr><td class="small">
<center>
{image_size}&nbsp;{image_unit}&nbsp;--&nbsp;{orig_width}x{orig_height}&nbsp;px</center>
</td></tr>
