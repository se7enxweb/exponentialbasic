<form method="post" action="{www_dir}{index}/link/typeedit/">
...
<!-- BEGIN item_move_down_tpl -->
	<td width="1%"><a href="{www_dir}{index}/link/typeedit/down/{type_id}/{attribute_id}"><img src="{www_dir}/design/admin/images/move-down.gif" height="12" width="12" border="0" alt="Move down" /></a></td>
...
<!-- BEGIN item_move_up_tpl -->
	<td width="1%"><a href="{www_dir}{index}/link/typeedit/up/{type_id}/{attribute_id}"><img src="{www_dir}/design/admin/images/move-up.gif" height="12" width="12" border="0" alt="Move up" /></a></td>
