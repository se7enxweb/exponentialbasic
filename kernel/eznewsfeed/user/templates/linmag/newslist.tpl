...
<tr>
	...
	<img src="{www_dir}/design/admin/images/layout/path-arrow.gif" height="10" width="12" border="0" alt="" />&nbsp;<a class="path" href="{www_dir}{index}{first_news_url}">{intl-read_more}</a>
	</td>
</tr>
</table>
...
{starttr}
	...
	<img src="{www_dir}/design/admin/images/layout/path-arrow.gif" height="10" width="12" border="0" alt="" />&nbsp;<a class="path" href="{www_dir}{index}{news_url}">{intl-read_more}</a>
	</td>
{endtr}
<!-- END news_item_tpl -->
</table>
