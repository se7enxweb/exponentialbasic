<form action="{www_dir}{index}/trade/productedit/fileedit/new/{product_id}/" method="post">

<h1>{intl-files}: {product_name}</h1>
...
<tr>
	...
	<td width="1%" class="{td_class}">
	<a href="{www_dir}{index}/trade/productedit/fileedit/edit/{file_id}/{product_id}/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('eztp{file_number}-red','','{www_dir}/design/admin/images/{site_style}/redigerminimrk.gif',1)"><img name="eztp{file_number}-red" border="0" src="{www_dir}/design/admin/images/{site_style}/redigermini.gif" width="16" height="16" align="top" border="0" alt="Edit" /></a>
	</td>
