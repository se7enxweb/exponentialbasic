<!-- orderlist.tpl --> 
<!-- $Id: orderedit.tpl,v 1.8.2.1 2001/11/22 11:27:02 br Exp $ -->
...
<tr>
	...
	<div class="p"><a href="mailto:{customer_email}">{customer_email}</a>
	<br /> 
	( <a href="{www_dir}{index}/trade/customerview/{customer_id}/" >{intl-view_customer}</a> ) ( <a href="{www_dir}{index}/user/useredit/edit/{customer_id}/" >{intl-view_customer_user}</a> )</div>
	<br /></td>
	<td align="right"><p class="boxtext">{intl-preorder_id}:</p>
        <div class="p">{preorder_id}</div>
	<br /><br /></td>
	<td align="right" width="45%"><p class="boxtext">{intl-order_id}:</p>
