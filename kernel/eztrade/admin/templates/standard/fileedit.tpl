<form method="post" action="{www_dir}{index}/trade/productedit/fileedit/" enctype="multipart/form-data">
<input type="hidden" name="max_file_size" value="30000000">

<h1>{intl-file_upload}: {product_name}</h1>
...
<tr>
	...
	<form method="post" action="{www_dir}{index}/trade/productedit/filelist/{product_id}/">
