...
{
  function ezuspsget($ser,$user,$pwd,$totarr,$wgt="",$dzip,$dsta,$dcou,$ozip,$sta,$cou,$street1,$street2="",$mach="false")
  {
    $this->server = $ser;
    $this->user = $user;
    $this->pass = $pwd;
...
function getservice()
{
  ...
  elseif(($this->country!="Canada")||($this->country!="United States of America"))
  {
    ...
    $servicearr[1] = "Priority Lg";$this->num = $n;
    $servicearr[2] = "Priority Sm";
    $servicearr[3] = "Priority Var";
    $this->service = $servicearr;
  }
...
function getresult()
{
  ...
  //  print_r( $ratestotal );
    ...
    */
    ...
    // echo "<br /><hr />";
  } elseif ( $this->destcountry == "Great Britain" ) {
  //  print_r( $ratestotal[0] ); echo "<br />";
    unset( $ratestotal[0] );
