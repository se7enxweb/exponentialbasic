...
CREATE TABLE eZTrade_AttributeValue (
  ...
  PRIMARY KEY (`ID`),
  KEY TradeAttributeValue_ProductID (ProductID),
  KEY TradeAttributeValue_AttributeID (AttributeID)
);
...
CREATE TABLE eZTrade_Cart (
  ...
  PRIMARY KEY (`ID`),
  KEY Trade_CartSessionID (SessionID),
  KEY TradeCart_Session (SessionID)
);
...
CREATE TABLE eZTrade_CartOptionValue (
  ...
  Count int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY TradeCartOptionValue_CartItemID (CartItemID)
);
...
CREATE TABLE eZTrade_Category (
  ...
  PRIMARY KEY (`ID`),
  KEY TradeCategory_Name (`Name`),
  KEY TradeCategory_Parent (Parent)
);
...
CREATE TABLE eZTrade_OptionValueContent (
  ...
  PRIMARY KEY (`ID`),
  KEY TradeProductOption_OptionValueContent (ValueID)
);
...
CREATE TABLE eZTrade_Product (
  ...
  PRIMARY KEY (`ID`),
  KEY TradeProduct_Name (`Name`),
  KEY TradeProduct_Keywords (Keywords),
  KEY TradeProduct_Price (Price)
);
...
CREATE TABLE eZTrade_ProductCategoryDefinition (
  ...
  PRIMARY KEY (`ID`),
  KEY TradeProductDef_ProductID (ProductID)
);
...
CREATE TABLE eZTrade_ProductCategoryLink (
  ...
  Placement int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`ID`),
  KEY TradeProductLink_CategoryID (CategoryID),
  KEY TradeProductLink_ProductID (ProductID)
);
...
CREATE TABLE eZTrade_ProductOptionLink (
  ...
  OptionID int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY TradeProductOption_ProductID (ProductID),
  KEY TradeProductOption_OptionID (OptionID)
);
