...
<!-- start #contentWrap -->
<div id="contentWrap">
   <h1 class="mainHeading">{intl-hot_deals}</h1>
...
<!-- BEGIN product_image_tpl -->
	<a href="{www_dir}{index}/{module}/{module_view}/{product_id}/{category_id}/">
        <img src="{www_dir}{product_image_uri}" border="0" width="{product_image_width}" height="{product_image_height}" alt="{product_image_caption}"/>
	</a>
