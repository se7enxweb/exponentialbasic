...
<!-- start #contentWrap -->
<div id="contentWrap">
   <h1 class="mainHeading">{intl-confirming-order}</h1>
...
<!-- BEGIN full_cart_tpl --><table class="list" width="90%" cellspacing="0" cellpadding="4" border="0"><!-- BEGIN cart_item_list_tpl -->
<tr>
    <th>&nbsp;</th>
...
<tr>
    <td>&nbsp;</td>
    <th colspan="{subtotals_span_size}" class="right">{intl-tax_total}:</th>
