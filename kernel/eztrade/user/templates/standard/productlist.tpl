...
<!-- <div class="spacer"><div class="pris"><input type="image" src="<? print $GlobalSiteIni->WWWDir; ?>/design/<? print ($GlobalSiteDesign); ?>/images/buynow.gif" name="AddToCart" alt="{intl-add_to_cart}" /></div></div> -->
