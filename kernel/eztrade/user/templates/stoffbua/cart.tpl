...
<!-- cart.tpl --> 
<!-- $Id: cart.tpl 6304 2001-07-29 23:31:17Z kaid $ -->
...
onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ezuser{cart_item_id}-slett','','/design/base/images/icons/slettminimrk.gif',1)"><img name="ezuser{cart_item_id}-slett" border="0" src="{www_dir}/eztrade/user/design/base/images/icons/slettmini.gif" width="16" height="16" align="top"></a>
	</td>
</tr>
<!-- END cart_item_tpl -->
