...
<!--
kracker@gci.net: added ezRegion filed (should resemble ezcountry + text field)
prana@slather.com: updated eZRegion to be a drop down (add text filed, later)
-->
...
<!--
prana@slather.com: moved zip code to create a more natural flow for US users  8/1/2001
-->
...
<!--
<br>
<input type="text" size="20" name="Region[]" value="{region_value}"/>
-->
